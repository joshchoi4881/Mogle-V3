...
<html lang="en">
    ...
    <body>
        ...
        <section class="center">
            ...
            <div class="card center">
                <h1 class="ovo">DoorDash (Hackensack, NJ)</h1>
                <br/>
                <p class="gilroy">Delivery Breakdown Stats:</p>
                <br/>
                <div class="center">
